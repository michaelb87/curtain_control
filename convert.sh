...
#Dieses Skript übersetzt Dateien im Ordner websites (ohne Unterverzeichnisse) in eine Flash-Datei,
...
# convert material design paths
sed -i "s/\/fonts\/material-design-icons/\/material-design-icons/g" phonon.min.css
